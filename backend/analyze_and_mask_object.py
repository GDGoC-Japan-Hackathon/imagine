...
def convert_to_percent(pan, tilt):
...
def image_analysis_and_masking(file_path = None,pan = None,tilt = None):
    ...
    if file_path:
        ...
        return img,location_desc, norm_x, norm_y
    else:
...
# ==========================================
def analyze_image_at_location(img, location_desc):
...
# ==========================================
def create_mask_for_target(img, target_name, location_desc, norm_x, norm_y):
